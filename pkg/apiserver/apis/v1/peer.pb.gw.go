...
func request_PeerService_WatchUpstream_0(ctx context.Context, marshaler runtime.Marshaler, client PeerServiceClient, req *http.Request, pathParams map[string]string) (PeerService_WatchUpstreamClient, runtime.ServerMetadata, error) {
	var protoReq WatchUpstreamRequest
	var metadata runtime.ServerMetadata

	stream, err := client.WatchUpstream(ctx, &protoReq)
	if err != nil {
...
func RegisterPeerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PeerServiceServer) error {
	...
	mux.Handle("GET", pattern_PeerService_WatchUpstream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterPeerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PeerServiceClient) error {
	...
	mux.Handle("GET", pattern_PeerService_WatchUpstream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/compass.api.v1.PeerService/WatchUpstream", runtime.WithHTTPPathPattern("/v1/upstreams"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PeerService_WatchUpstream_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_PeerService_WatchUpstream_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_PeerService_WatchUpstream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "upstreams"}, ""))
)

var (
	forward_PeerService_WatchUpstream_0 = runtime.ForwardResponseStream
)
